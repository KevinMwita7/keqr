...
void main() {
  ...
  group('AdditionalData Validation', () {
    ...
    test('merchantChannel accepts valid 3-digit codes', () {
      expect(
        () => AdditionalData(merchantChannel: '001'),
        returnsNormally,
      );
      expect(
        () => AdditionalData(merchantChannel: '830'),
        returnsNormally,
      );
    });
    ...
    test('merchantChannel rejects invalid length', () {
      expect(
        () => AdditionalData(merchantChannel: '01'),
        throwsArgumentError,
      );
      expect(
    ...
    test('merchantChannel rejects non-numeric', () {
      expect(
        () => AdditionalData(merchantChannel: 'ABC'),
        throwsArgumentError,
      );
    });
    ...
    test('merchantChannel validates position 1 (media) range 0-8', () {
      expect(
        () => AdditionalData(merchantChannel: '801'),
        returnsNormally,
      );
      expect(
        () => AdditionalData(merchantChannel: '901'),
        throwsArgumentError,
      );
    });
    ...
    test('merchantChannel validates position 2 (scan location) range 0-3', () {
      expect(
        () => AdditionalData(merchantChannel: '031'),
        returnsNormally,
      );
      expect(
        () => AdditionalData(merchantChannel: '041'),
        throwsArgumentError,
      );
    });

    test('merchantChannel validates position 3 (merchant presence) range 0-3', () {
      expect(
        () => AdditionalData(merchantChannel: '003'),
        returnsNormally,
      );
      expect(
